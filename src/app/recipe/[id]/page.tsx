...
const RecipeDetails = () => {
  ...
  console.log(missedIngredientsString);
  const missedIngredients = missedIngredientsString
    ? JSON.parse(missedIngredientsString)
    : [];
  const usedIngredients = usedIngredientsString
    ? JSON.parse(usedIngredientsString)
    : [];
    ...
    const fetchRecipe = async () => {
      try {
        const response = await axios.get(
          `https://api.spoonacular.com/recipes/${id}/information?includeNutrition=false&apiKey=35cd120e3fd040a3aa3f63ab6f7a0fa3`
        );
    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center">
          <h2 className="text-black bg-slate-500 p-2 m-0 rounded-md mr-2">
            Missing Ingredients:{" "}
          </h2>
